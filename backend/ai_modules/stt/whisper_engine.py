...
from database.crud import init_db, save_to_database
    ...
    try:
        ...
        while True:
            ...
            if current_volume > 0.0005: 
                print(f"🔊 [DEBUG] Mic Volume: {current_volume:.5f} (Required: > {SILENCE_RMS_THRESHOLD})")
